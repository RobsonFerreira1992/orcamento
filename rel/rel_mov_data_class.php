...
<div class="container">
			...
			<div class="row">
				...
				<small><?php 
					if($status == 'Todos'){
						echo 'Todos as Movimentações';
					}else{
						echo 'Movimentaçoes de:'.$tipo;
					}
				 ?></small>
				</div>
		...
		$quant_aprovados = 0;
		 ...
		 if($status != 'Todos'){
            ...
            $query = "select o.tecnico, o.valor_total, o.data_abertura, o.data_geracao, o.data_aprovacao, o.status, f.nome as func_nome from orcamento as o INNER JOIN funcionarios as f on o.tecnico = f.id where (o.data_abertura >= '$dataInicial' and o.data_abertura <= '$dataFinal') and o.status = '$status' order by o.data_abertura asc";
            }
            else{
            $query = "select o.tecnico, o.valor_total, o.data_abertura, o.data_geracao, o.data_aprovacao, o.status, f.nome as func_nome from orcamento as o INNER JOIN funcionarios as f on o.tecnico = f.id where o.data_abertura >= '$dataInicial' and o.data_abertura <= '$dataFinal'  order by data_abertura asc";
            }
